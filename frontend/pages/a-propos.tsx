      ...
      <section className="relative pt-44 pb-32 overflow-hidden bg-white border-b border-[#3fad28]/5">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center max-w-4xl">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-xs font-bold uppercase tracking-widest">
            <span className="text-[#3fad28]/60">15 ans d&apos;expérience</span>
            <span className="text-[#e68d15]">&middot;</span>
            <span className="text-[#3fad28]/60">500+ clientes transformées</span>
            <span className="text-[#e68d15]">&middot;</span>
            <span className="text-[#3fad28]/60">22 produits formulés</span>
          </div>
        </div>
      </section>
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="absolute -bottom-10 -right-10 bg-white p-8 rounded-[2.5rem] shadow-2xl z-20 border border-[#3fad28]/5 animate-float max-w-[240px]">
                <div className="flex items-center gap-4 mb-3">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest text-[#3fad28]">Certification</span>
                </div>
      ...
      <section className="py-32 bg-[#3fad28] rounded-[5rem] mx-6 relative overflow-hidden">
        ...
        <div className="container mx-auto px-10 max-w-7xl relative z-10">
          <div className="text-center mb-24">
            <span className="text-[#e68d15] font-bold tracking-[0.4em] uppercase text-[10px] mb-6 block">Notre Éthique</span>
