      ...
      <section className="relative pt-44 pb-24 overflow-hidden bg-white border-b border-[#2D4A1E]/5">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 text-xs font-bold uppercase tracking-widest">
            <span className="bg-[#2D4A1E]/10 text-[#2D4A1E] px-4 py-2 rounded-full">✓ 100% Naturel</span>
            <span className="bg-[#2D4A1E]/10 text-[#2D4A1E] px-4 py-2 rounded-full">✓ Zéro Chimie</span>
            <span className="bg-[#2D4A1E]/10 text-[#2D4A1E] px-4 py-2 rounded-full">✓ Livraison Gratuite dès 50€</span>
            <span className="bg-[#2D4A1E]/10 text-[#2D4A1E] px-4 py-2 rounded-full">✓ Formulés par Naturopathe</span>
          </div>
        </div>
      </section>
