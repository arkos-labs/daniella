...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#F8F5EE] overflow-x-hidden">
      ...
      <section className="relative h-[100dvh] md:min-h-screen flex items-center overflow-hidden bg-[#000000]">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#3fad28]/40 via-transparent to-[#000000]/60 z-10"></div>
          
          {/* Gradient Mesh & Grain */}
          <div className="absolute inset-0 opacity-30 mix-blend-overlay pointer-events-none z-20">
            <div className="absolute top-[-20%] left-[-10%] w-[80%] h-[80%] bg-[#e68d15]/20 rounded-full blur-[150px] animate-pulse"></div>
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#000000]/80 via-[#000000]/20 to-transparent z-20"></div>
        </div>
        ...
        <div className="container mx-auto px-6 relative z-30 pt-20 md:pt-48 pb-6">
          <div className="max-w-5xl mx-auto text-center flex flex-col">
            ...
            <p className="text-[#f7a941] text-[10px] md:text-base font-bold uppercase tracking-[0.3em] md:tracking-[0.4em] mb-4 md:mt-16 md:mb-12 drop-shadow-md animate-reveal-up order-1 md:order-3" style={{ animationFillMode: 'forwards' }}>
            ...
            <div className="flex flex-col md:flex-row gap-3 md:gap-6 justify-center items-center mb-4 order-4">
              <Link href="/boutique" className="group relative px-8 md:px-10 py-3.5 md:py-6 bg-white text-[#000000] rounded-full font-bold uppercase tracking-widest text-[10px] md:text-xs overflow-hidden transition-all shadow-2xl w-full md:w-auto min-w-[260px]">
                <span className="relative z-10 flex items-center justify-center gap-2">
                  DÉCOUVRIR NOS PRODUITS <ArrowRight className="w-4 h-4 md:w-5 md:h-5" />
                </span>
              </Link>
              
              <Link href="/reservations" className="group px-8 md:px-10 py-3.5 md:py-6 border border-white/20 rounded-full flex items-center justify-center gap-3 text-white hover:bg-white hover:text-[#000000] transition-all text-[10px] md:text-xs font-bold uppercase tracking-widest backdrop-blur-sm w-full md:w-auto">
                <Droplets className="w-4 h-4 md:w-5 md:h-5 text-[#e68d15]" />
        ...
        <div className="absolute bottom-10 left-0 right-0 z-30 px-6">
          <div className="flex flex-wrap justify-center gap-x-6 md:gap-x-12 gap-y-3 text-[9px] md:text-xs text-white/60 font-bold animate-reveal-up opacity-0" style={{ animationDelay: '0.8s', animationFillMode: 'forwards' }}>
            <span className="flex items-center gap-2 tracking-[0.15em] md:tracking-[0.2em] uppercase">
              <CheckCircle2 className="w-3 h-3 text-[#e68d15]" /> 
      ...
      <div className="py-6 md:py-12 bg-white border-y border-[#3fad28]/5 overflow-hidden">
        <div className="flex whitespace-nowrap animate-marquee">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="flex items-center gap-16 px-16 shrink-0">
              <span className="text-base md:text-lg font-serif text-[#3fad28] uppercase tracking-[0.2em] flex items-center gap-4">
                <span className="opacity-0 w-8"></span> {/* Safe area gap */}
                Livraison Offerte dès 50€
              </span>
              <span className="w-1.5 h-1.5 rounded-full bg-[#e68d15]"></span>
              <span className="text-base md:text-lg font-serif text-[#3fad28] uppercase tracking-[0.2em]">Paiement 100% Sécurisé</span>
              <span className="w-1.5 h-1.5 rounded-full bg-[#e68d15]"></span>
              <span className="text-base md:text-lg font-serif text-[#3fad28] uppercase tracking-[0.2em]">Conseils Personnalisés</span>
              <span className="w-1.5 h-1.5 rounded-full bg-[#e68d15]"></span>
              <span className="text-base md:text-lg font-serif text-[#3fad28] uppercase tracking-[0.2em]">Expédition sous 48h</span>
              <span className="w-1.5 h-1.5 rounded-full bg-[#e68d15]"></span>
            </div>
          ))}
        </div>
      ...
      <section className="py-32 bg-[#F8F5EE] relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-[40%] h-full bg-[#3fad28]/[0.02] -skew-x-12 translate-x-24"></div>
        
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-24 max-w-4xl mx-auto">
            <h2 className="text-5xl md:text-7xl font-serif text-[#1a1a1a] leading-tight">
              Pourquoi Choisir Nos <br /> <span className="italic text-[#3fad28]">Cosmétiques Naturels</span> ?
            </h2>
          </div>

          <div className="grid lg:grid-cols-3 gap-10">
            {/* Pillar 1 */}
            <div className="group relative bg-white rounded-[3rem] p-12 transition-all duration-700 hover:-translate-y-4 shadow-xl shadow-black/5 hover:shadow-2xl hover:shadow-[#3fad28]/10 border border-[#3fad28]/5 overflow-hidden">
              <div className="absolute top-0 left-0 w-2 h-full bg-[#e68d15] opacity-0 group-hover:opacity-100 transition-opacity"></div>
              <div className="w-20 h-20 bg-[#F8F5EE] rounded-2xl flex items-center justify-center mb-10 group-hover:bg-[#3fad28] transition-colors duration-500">
                <Leaf className="w-8 h-8 text-[#3fad28] group-hover:text-white group-hover:rotate-[15deg] transition-all duration-500" />
              </div>
              <h3 className="text-3xl font-serif text-[#1a1a1a] mb-6">Pureté Absolue</h3>
              ...
              <p className="text-[#3fad28] font-bold text-[10px] uppercase tracking-widest opacity-40">
            ...
            <div className="group relative bg-white rounded-[3rem] p-12 transition-all duration-700 hover:-translate-y-4 shadow-xl shadow-black/5 hover:shadow-2xl hover:shadow-[#3fad28]/10 border border-[#3fad28]/5 overflow-hidden">
              <div className="absolute top-0 left-0 w-2 h-full bg-[#e68d15] opacity-0 group-hover:opacity-100 transition-opacity"></div>
              <div className="w-20 h-20 bg-[#F8F5EE] rounded-2xl flex items-center justify-center mb-10 group-hover:bg-[#3fad28] transition-colors duration-500">
                <Wind className="w-8 h-8 text-[#3fad28] group-hover:text-white group-hover:-rotate-[15deg] transition-all duration-500" />
              </div>
              <h3 className="text-3xl font-serif text-[#1a1a1a] mb-6">Savoir-faire Rare</h3>
              <p className="text-gray-500 font-light leading-relaxed mb-8 text-lg">
            ...
            <div className="group relative bg-white rounded-[3rem] p-12 transition-all duration-700 hover:-translate-y-4 shadow-xl shadow-black/5 hover:shadow-2xl hover:shadow-[#3fad28]/10 border border-[#3fad28]/5 overflow-hidden">
              <div className="absolute top-0 left-0 w-2 h-full bg-[#e68d15] opacity-0 group-hover:opacity-100 transition-opacity"></div>
              <div className="w-20 h-20 bg-[#F8F5EE] rounded-2xl flex items-center justify-center mb-10 group-hover:bg-[#3fad28] transition-colors duration-500">
                <Sparkles className="w-8 h-8 text-[#3fad28] group-hover:text-white group-hover:scale-125 transition-all duration-500" />
              </div>
              <h3 className="text-3xl font-serif text-[#1a1a1a] mb-6">Éclat Naturel</h3>
              <p className="text-gray-500 font-light leading-relaxed mb-8 text-lg">
      ...
      <section className="py-24 bg-[#3fad28] text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link href="/boutique" className="bg-white text-[#3fad28] px-10 py-5 rounded-full font-bold uppercase tracking-widest hover:bg-[#F8F5EE] transition-all">
              Découvrir Nos Cosmétiques
            </Link>
            <Link href="/reservations" className="border border-white text-white px-10 py-5 rounded-full font-bold uppercase tracking-widest hover:bg-white hover:text-[#3fad28] transition-all">
              ...
              <div key={product.id} className={`card-hover bg-white rounded-[3rem] p-4 flex flex-col h-full animate-reveal-up`} style={{ animationDelay: `${idx * 0.1}s` }}>
                <div className="relative aspect-square rounded-[2.5rem] overflow-hidden mb-8 group/img">
                  ...
                  <div className="absolute inset-0 bg-black/0 group-hover/img:bg-black/20 transition-colors duration-300 flex items-center justify-center gap-4 opacity-0 group-hover/img:opacity-100">
                    <button className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-[#3fad28] hover:bg-[#3fad28] hover:text-white transition-all">
                ...
                <div className="px-4 pb-4 flex flex-col flex-1">
                  <div className="flex items-center gap-1 mb-3">
                    <Star className="w-3 h-3 fill-[#e68d15] text-[#e68d15]" />
                    <Star className="w-3 h-3 fill-[#e68d15] text-[#e68d15]" />
                    <Star className="w-3 h-3 fill-[#e68d15] text-[#e68d15]" />
                    <Star className="w-3 h-3 fill-[#e68d15] text-[#e68d15]" />
                    <Star className="w-3 h-3 fill-[#e68d15] text-[#e68d15]" />
                  </div>
                  <h3 className="text-xl font-serif text-[#1a1a1a] mb-4 line-clamp-2 h-14 hover:text-[#3fad28] cursor-pointer transition-colors">
                    <Link href={`/produit/${product.id}`}>{product.name}</Link>
                  </h3>
                  <div className="mt-auto pt-6 border-t border-[#3fad28]/5">
                    <div className="flex items-center justify-between mb-4">
                      <span className="text-2xl font-serif text-[#3fad28]">{product.price.toFixed(2)}€</span>
                      <button className="text-[10px] font-bold uppercase tracking-widest text-gray-400 hover:text-[#e68d15] transition-colors">Détails</button>
                    </div>
                    <button 
                      onClick={() => {
                        addItem({ productId: product.id, name: product.name, price: product.price, quantity: 1, imageUrl: product.imageUrl });
                      }}
                      className="w-full py-4 bg-[#3fad28] text-white rounded-full text-[10px] font-bold uppercase tracking-widest shadow-lg shadow-[#3fad28]/20 hover:bg-[#000000] transition-all flex items-center justify-center gap-2"
                    >
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif text-[#1a1a1a]">Pourquoi 500+ Clients Nous Font Confiance</h2>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center p-8 bg-[#F8F5EE] rounded-[2rem] hover:shadow-xl transition-all">
              <div className="text-3xl mb-4">⚡</div>
              <h4 className="font-bold text-[#3fad28] mb-2">Livraison Rapide</h4>
            ...
            <div className="text-center p-8 bg-[#F8F5EE] rounded-[2rem] hover:shadow-xl transition-all">
              <div className="text-3xl mb-4">🔒</div>
              <h4 className="font-bold text-[#3fad28] mb-2">Paiement Sécurisé</h4>
              <ul className="text-sm text-gray-500 space-y-1">
                <li>Stripe & PayPal</li>
            ...
            <div className="text-center p-8 bg-[#F8F5EE] rounded-[2rem] hover:shadow-xl transition-all">
              <div className="text-3xl mb-4">💬</div>
              <h4 className="font-bold text-[#3fad28] mb-2">Conseils Personnalisés</h4>
              <ul className="text-sm text-gray-500 space-y-1">
            ...
            <div className="text-center p-8 bg-[#F8F5EE] rounded-[2rem] hover:shadow-xl transition-all">
              <div className="text-3xl mb-4">📦</div>
              <h4 className="font-bold text-[#3fad28] mb-2">Livraison Offerte</h4>
              <ul className="text-sm text-gray-500 space-y-1">
      ...
      <section className="py-24 bg-[#F8F5EE]">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-serif text-[#1a1a1a]">Ce que disent nos clientes satisfaites</h2>
          </div>
            ...
            {[
              ...
              <div key={i} className="bg-white p-10 rounded-[3rem] shadow-sm hover:shadow-md transition-all">
                <div className="flex gap-1 mb-6">
                  {[...Array(5)].map((_, i) => <Star key={i} className="w-4 h-4 fill-[#e68d15] text-[#e68d15]" />)}
                </div>
                <p className="text-lg text-gray-600 font-light mb-8 italic">"{t.text}"</p>
                <div>
                  <h4 className="font-bold text-[#3fad28]">{t.name}</h4>
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="relative group animate-reveal-up">
              ...
              <div className="absolute -top-10 -right-10 w-64 h-64 border border-[#e68d15]/30 rounded-full animate-float"></div>
              <div className="absolute -bottom-10 -left-10 w-48 h-48 bg-[#3fad28]/5 rounded-full blur-3xl"></div>
            </div>

            <div className="animate-reveal-up delay-200">
              <span className="section-tag mb-6">La Fondatrice</span>
              <h2 className="text-6xl md:text-8xl font-serif text-[#1a1a1a] mb-8 leading-tight">
                La Fondatrice : <br /> <span className="italic">Daniella Adabra</span>
              </h2>
              
              <blockquote className="text-3xl font-serif text-[#3fad28] italic border-l-4 border-[#e68d15] pl-10 mb-10 leading-snug">
              ...
              <p className="text-lg text-gray-500 font-light mb-12 leading-relaxed max-w-xl">
                Naturopathe certifiée et créatrice passionnée, <Link href="/apropos" className="text-[#3fad28] font-medium">Daniella Adabra</Link> a dédié sa vie à réconcilier la beauté et la santé. Diplômée en Naturopathie Holistique en France, elle est experte en formulation cosmétique naturelle et passionnée par les ingrédients africains authentiques.
              </p>
              
              <div className="grid grid-cols-1 gap-6 mb-12">
                <div className="flex items-center gap-4">
                  <CheckCircle2 className="w-6 h-6 text-[#e68d15]" />
                  <span className="text-sm font-bold uppercase tracking-widest text-[#3fad28]">Diplôme en Naturopathie Holistique (France)</span>
                </div>
                <div className="flex items-center gap-4">
                  <CheckCircle2 className="w-6 h-6 text-[#e68d15]" />
                  <span className="text-sm font-bold uppercase tracking-widest text-[#3fad28]">Experte en Formulation Cosmétique Naturelle</span>
                </div>
                <div className="flex items-center gap-4">
                  <CheckCircle2 className="w-6 h-6 text-[#e68d15]" />
                  <span className="text-sm font-bold uppercase tracking-widest text-[#3fad28]">Passionnée par les Ingrédients Africains Authentiques</span>
                </div>
              </div>
      ...
      <section id="reservations" className="py-24 md:py-40 bg-[#000000] relative overflow-hidden">
        {/* Artistic Background Elements */}
        <div className="absolute top-0 right-0 w-full h-full pointer-events-none">
          <div className="absolute top-[-10%] right-[-10%] w-[60%] h-[60%] bg-[#3fad28]/20 rounded-full blur-[120px] animate-pulse"></div>
          <div className="absolute bottom-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#e68d15]/10 rounded-full blur-[100px]"></div>
            ...
            <div className="grid lg:grid-cols-12 gap-16 items-start">
              ...
              <div className="lg:col-span-5 text-white">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-md">
                  <Sparkles className="w-4 h-4 text-[#e68d15]" />
                  <span className="text-xs font-bold uppercase tracking-[0.2em] text-white/80">Expérience Exclusive</span>
                </div>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={i} className="group relative p-6 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-[#e68d15]/30 transition-all duration-500 cursor-pointer">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-6">
                          <div className="w-12 h-12 rounded-2xl bg-[#e68d15]/10 flex items-center justify-center group-hover:bg-[#e68d15] transition-colors duration-500">
                            <service.icon className="w-5 h-5 text-[#e68d15] group-hover:text-white" />
                          </div>
                          <div>
                            <h4 className="text-lg font-serif text-white group-hover:text-[#e68d15] transition-colors">{service.title}</h4>
                            <p className="text-xs text-white/40 uppercase tracking-widest">{service.desc}</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="text-lg font-serif text-[#e68d15]">{service.price}</div>
                          <div className="text-xs text-white/30 uppercase">{service.duration}</div>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <div className="bg-[#242422] rounded-[2.5rem] md:rounded-[3.5rem] p-4 md:p-10 border border-white/5 shadow-2xl relative overflow-hidden">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between mb-8 md:mb-10 gap-6 px-2">
                    <div className="text-center sm:text-left">
                      ...
                      <p className="text-xs text-white/40 uppercase tracking-[0.2em] mt-1">Sélectionnez votre créneau</p>
                    </div>
                    <div className="flex items-center gap-3 md:gap-6 bg-white/5 rounded-full px-4 md:px-6 py-2 md:py-3 border border-white/10">
                      ...
                      <span className="text-xs font-bold text-white uppercase tracking-widest min-w-[70px] md:min-w-[100px] text-center">Mai 2026</span>
                    ...
                    <div className="bg-white/[0.02] rounded-[2rem] md:rounded-[2.5rem] p-3 md:p-6 border border-white/5">
                        ...
                        {daysArray.map(day => (
                          <button
                            ...
                            className={`aspect-square rounded-xl md:rounded-2xl flex flex-col items-center justify-center transition-all duration-300 relative group ${
                              selectedDate === day 
                                ? 'bg-[#e68d15] text-white shadow-xl shadow-[#e68d15]/20' 
                                : 'text-white/60 hover:bg-white/5 hover:text-white'
                            }`}
                          >
                            <span className="text-xs font-medium">{day}</span>
                            {day % 7 === 0 && selectedDate !== day && (
                              <span className="absolute bottom-1 w-0.5 h-0.5 md:w-1 md:h-1 bg-[#e68d15] rounded-full group-hover:bg-white"></span>
                            )}
                          </button>
                        ))}
                      </div>
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-white/5">
                        <div className="flex items-center gap-2">
                          <div className="w-2 h-2 rounded-full bg-[#e68d15]"></div>
                          <span className="text-xs text-white/40 uppercase tracking-widest">Disponible</span>
                        </div>
                        <span className="text-xs text-white/40 uppercase tracking-widest italic">Fuseau : Europe/Paris</span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col">
                      {!selectedDate ? (
                        ...
                        <div className="space-y-8 animate-reveal-up">
                          <div>
                            <span className="text-[10px] font-bold text-[#e68d15] uppercase tracking-widest block mb-5">Matinée</span>
                              ...
                              {times.matin.map(time => (
                                <button
                                  ...
                                  className={`py-4 rounded-2xl text-xs font-bold transition-all border ${
                                    selectedTime === time
                                      ? 'bg-white text-[#000000] border-white shadow-xl'
                          ...
                          <div>
                            <span className="text-[10px] font-bold text-[#e68d15] uppercase tracking-widest block mb-5">Après-midi</span>
                            <div className="grid grid-cols-2 gap-3">
                        ...
                        <button 
                          ...
                          className={`w-full py-6 rounded-2xl font-bold uppercase tracking-widest transition-all duration-700 flex items-center justify-center gap-3 group relative overflow-hidden ${
                            selectedDate && selectedTime
                              ? 'bg-[#e68d15] text-white shadow-2xl shadow-[#e68d15]/40 hover:translate-y-[-2px]'
      ...
      {/* FAQ SEO Section */}
      <section className="py-24 bg-white border-t border-[#3fad28]/5">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="text-center mb-16">
            <span className="section-tag mb-4">Questions Fréquentes</span>
            <h2 className="text-4xl md:text-5xl font-serif text-[#1a1a1a]">Tout Savoir sur Nos Cosmétiques Naturels</h2>
          </div>
          <div className="space-y-6">
            {[
              {
              ...
              <div key={i} className="bg-[#F8F5EE] rounded-[2rem] p-8">
                <h3 className="text-lg font-serif text-[#1a1a1a] mb-3">{faq.q}</h3>
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-x-12 gap-y-4">
            <Link href="/collection" className="text-sm text-gray-400 hover:text-[#3fad28] transition-colors uppercase tracking-widest font-bold">Cosmétiques Naturels</Link>
            <Link href="/consultations" className="text-sm text-gray-400 hover:text-[#3fad28] transition-colors uppercase tracking-widest font-bold">Consultation Naturopathe</Link>
            <Link href="/blog" className="text-sm text-gray-400 hover:text-[#3fad28] transition-colors uppercase tracking-widest font-bold">Blog Beauté Africaine</Link>
            <Link href="/a-propos" className="text-sm text-gray-400 hover:text-[#3fad28] transition-colors uppercase tracking-widest font-bold">Daniella Adabra</Link>
            <Link href="/produit/poudre-chebe" className="text-sm text-gray-400 hover:text-[#3fad28] transition-colors uppercase tracking-widest font-bold">Poudre Chébé</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 bg-[#F8F5EE]">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto bg-white rounded-[4rem] p-12 md:p-24 shadow-xl text-center relative overflow-hidden">
            <div className="absolute top-[-100px] left-[-100px] w-64 h-64 bg-[#3fad28]/5 rounded-full blur-3xl"></div>
            <div className="absolute bottom-[-100px] right-[-100px] w-64 h-64 bg-[#e68d15]/10 rounded-full blur-3xl"></div>
            
            <span className="section-tag mb-8">La Communauté</span>
            <h2 className="text-5xl md:text-6xl font-serif text-[#1a1a1a] mb-8">Rejoignez l'univers DNC</h2>
            ...
            <form className="flex flex-col md:flex-row gap-4 max-w-lg mx-auto" onSubmit={(e) => e.preventDefault()}>
              <input 
                ...
                className="flex-1 bg-[#F8F5EE] border-none rounded-full px-8 py-5 focus:ring-2 focus:ring-[#3fad28] transition-all outline-none text-sm"
              />
